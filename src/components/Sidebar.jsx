...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { id: 'proveedores',     label: 'Proveedores',         icon: '🏭', section: 'Compras' },
    { id: 'productos',       label: 'Productos',           icon: '📦', section: 'Compras' },
    { id: 'compras',         label: 'Facturas Compra',     icon: '🧾', section: 'Compras' },
    { id: 'controlPagos',    label: 'Control de Pagos',    icon: '💳', section: 'Compras' },
    ...
    { id: 'archivoUpaca',    label: 'Archivo Proveedor',   icon: '🏭', section: 'Archivos PDF' },
